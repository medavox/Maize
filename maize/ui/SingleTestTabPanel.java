...
import maize.*;
public class SingleTestTabPanel extends JPanel implements ActionListener, ChangeListener{
    ...
    public SingleTestTabPanel(MazeTest mazeTest, BotTabPanel botSelector, MazeTabPanel mazeSelector) throws IOException{
